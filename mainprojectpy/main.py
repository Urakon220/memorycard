...
with open ("questions_list.json", "w") as file:
    data = [question.__dict__ for question in questions]
    json.dump(data, file)
...
win_card.setObjectName("BackgroundWidget")
win_card.setStyleSheet("""                                 
                     QWidget#BackgroundWidget{
                background-image: url(810322);
                background-position: center;
                background-repeat: no-repeat;
            }

                       """)
dadadadd=[rbtn1,rbtn2,rbtn3,rbtn4,text_pit]
for i in dadadadd:
